...
public class CreditApplicationReportResponse {
    ...
    public List<FacilityCapitalMarkersReportRow> getFacilities() { return facilities; }
    public void setFacilities(List<FacilityCapitalMarkersReportRow> value) { this.facilities = value; }
    public List<CreditApplicationConsent.Consent> getConsents() { return consents; }
    public void setConsents(List<CreditApplicationConsent.Consent> value) { this.consents = value; }
}
