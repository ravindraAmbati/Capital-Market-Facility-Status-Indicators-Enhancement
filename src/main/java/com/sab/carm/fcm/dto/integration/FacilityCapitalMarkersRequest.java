 ...
 *
 * FCM persists the indicator values supplied by CARM.
 * FCM does not calculate indicator defaults from facility/purpose
 * mappings.
 */
public class FacilityCapitalMarkersRequest {
    ...
    public CapitalMarkerRequest getAdvised() {
        return advised;
    }

    public void setAdvised(CapitalMarkerRequest value) {
        this.advised = value;
    }

    public CapitalMarkerRequest getCommitted() {
        return committed;
    }

    public void setCommitted(CapitalMarkerRequest value) {
        this.committed = value;
    }

    public CapitalMarkerRequest getUnconditionalCancellable() {
        return unconditionalCancellable;
    }

    public void setUnconditionalCancellable(
            CapitalMarkerRequest value) {
    ...
    public static class CapitalMarkerRequest {
        ...
        @Pattern(
                regexp = "[YN]",
                message = "indicator must be Y or N")
        ...
        public void setOverrideJustification(String value) {
            this.overrideJustification = value;
        }

        @AssertTrue(
                message =
                        "override justification is required when override is true")
        public boolean isOverrideJustificationValid() {

            if (!override) {
                return true;
            }

            return overrideJustification != null
